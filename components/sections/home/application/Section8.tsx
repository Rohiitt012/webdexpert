...
export default function Section8() {
    ...
    return (
        <>
            {/*application home section 8*/}
            <section className="application-home-section-8 pb-120 position-relative overflow-hidden">
                <div className="container position-relative z-1 text-center bg-primary rounded-3 py-120 ">
                    <div className="position-relative z-1">
                        ...
                        <h2 className="text-white pt-4 wow img-custom-anim-top">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-4 justify-content-center">
                            <Link
                                ...
                                data-aos-delay={200}
                                href="#"
                                className="btn btn-white popup-video"
                                onClick={(e) => {
                                    e.preventDefault();
                                    setIsOpen(true);
                                }}
                            >
                                <span className="text-dark">Watch free tutorial</span>
                            </Link>
                            <Link data-aos="fade-up" data-aos-delay={400} href="/pricing" className="btn btn-linear-3">
                                get started now
                            </Link>
                        </div>
                    </div>
