                    ...
                    <div className="container">
						<div className="row py-120 align-items-center">
							<div className="col-lg-5 order-lg-2 offset-lg-1">
								<img
									className="mt-lg-0 mb-5 wow img-custom-anim-right"
									src="/assets/img/application-img/pages/application/page-home/home-section-6/img-2.png"
									alt="AstraX"
								/>
							</div>
							<div className="col-lg-5 order-lg-1">
								<h2 className="my-3 text-anime-style-2">Tax form integration</h2>
								<p className="pb-4 text-anime-style-1">
									We offer a wide range of digital marketing services that cater to business of all
