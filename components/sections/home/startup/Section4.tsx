        ...
        <>
            ...
            <section className="startup-home-section-4 position-relative overflow-hidden pt-120">
                        ...
                        <div className="col-lg-6 pe-lg-5 col-md-10">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="d-flex align-items-center mb-3 gap-3" data-aos="fade-up" data-aos-delay={400}>
                                    ...
                                    <p className="mb-0 text-dark">24/7 online support available</p>
                                </li>
                            </ul>
                        ...
                        <div className="col-lg-6">
                            <div className="d-block">
                                <div className="position-relative d-inline-block mt-lg-0 mt-5">
                                    <img data-aos="zoom-in" data-aos-delay={600} className="rounded-3 shadow position-relative z-1 shadow-1" src="/assets/img/startup-img/pages/startup/page-home/home-section-4/img-1.png" alt="AstraX" />
                                    <div data-aos="fade-up-left">
                                        <img className="rounded-3 position-md-absolute position-relative top-100 start-md-100 start-0 translate-middle-md z-0 ms-md-5 mt-md-0 mt-4" src="/assets/img/startup-img/pages/startup/page-home/home-section-4/img-2.png" alt="AstraX" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="d-flex justify-content-center pt-250">
                    <Link href="/features" className="icon-shape icon-60 rounded-circle bg-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
                            <g clipPath="url(#clip0_349_1735)">
                                <rect width={16} height={16} transform="translate(16 16) rotate(-180)" fill="#794AFF" />
