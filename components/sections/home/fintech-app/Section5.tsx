                ...
                <div className="container position-relative z-1 overflow-hidden">
                    <div className="row">
                        <div className="text-center">
                            ...
                            <h2 className="my-3 text-primary text-anime-style-3">
                                Unleash
                    ...
                    <div className="row g-5 mt-80">
                        <div className="col-lg-4">
                            <div data-aos="fade-up" data-aos-delay={0} className="card-pricing rounded-4 border border-white border-opacity-10 p-md-6 p-4">
                                <span className="btn-text text-white opacity-50">Basic</span>
                                <h1 className="mb-3">$99</h1>
                                <p className="fs-7 text-white opacity-75">Best for small business owners, startups who needes landing page.</p>
                                <Link href="/pricing" className="mt-3 hover-up btn btn-outline-dark w-100 mb-6">
                                    try for free
                                </Link>
                                <span className="btn-text text-white">What’s included:</span>
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75 text-decoration-line-through">Marketing strategy</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">Competitive work analysis</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75 text-decoration-line-through">Social media share audit</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 pt-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">24/7 online support</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-4">
                            <div data-aos="fade-up" data-aos-delay={200} className="card-pricing rounded-4 bg-primary p-md-6 p-4 position-relative">
                                <span className="text-primary btn-text text-dark opacity-75">advanced</span>
                                <h1 className="mb-3 text-dark">$299</h1>
                                <p className="fs-7 text-dark">Best for small business owners, startups who needes landing page.</p>
                                <Link href="/pricing" className="mt-3 hover-up btn btn-dark text-primary border-dark w-100 mb-6">
                                    try for free
                                </Link>
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0 text-dark">Marketing strategy</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0 text-dark">Competitive work analysis</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0 text-dark text-decoration-line-through">Social media share audit</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary pt-3">
                                        <p className="fs-7 mb-0 text-dark">24/7 online support</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                </ul>
                                <span className="sale-off text-primary fs-8 fw-semibold position-absolute top-0 end-0 me-6 px-3 bg-dark pb-1">-25% off</span>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div data-aos="fade-up" data-aos-delay={400} className="card-pricing rounded-4 border border-white border-opacity-10 p-md-6 p-4">
                                <span className="text-white opacity-50 btn-text">team</span>
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">Marketing strategy</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">Competitive work analysis</p>
                                    ...
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 py-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">Social media share audit</p>
                                        <img className="filter-invert" src="/assets/img/fintech-app-img//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-white border-opacity-10 pt-3">
                                        <p className="fs-7 mb-0 text-white opacity-75">24/7 online support</p>
