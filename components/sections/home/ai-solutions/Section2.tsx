                            ...
                            <div className="row g-2">
                                <div className="col-md-6 text-center">
                                    <div className="position-relative">
                                        <img data-aos="fade-up" className="rounded-4" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-2/img-1.png" alt="AstraX" />
                                ...
                                <div className="col-md-6 mt-md-8 mt-10 pt-md-0 pt-5 text-center">
                                    ...
                                    <img data-aos="fade-up" data-aos-delay={400} className="rounded-4" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-2/img-2.png" alt="AstraX" />
                                </div>
                            </div>
                        </div>
