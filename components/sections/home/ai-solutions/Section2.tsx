                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 offset-lg-1 col-md-12 order-2 ">
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <span className="btn-text text-primary">since from 20222</span>
                            </div>
                            <h2 className="text-dark my-3 text-anime-style-3" aria-label="Your End-to-End Digital Growth Partner">Your End-to-End Digital Growth Partner</h2>
                            <p className="pb-4 text wow img-custom-anim-top">We deliver end-to-end digital solutions—including website development, redesign, maintenance, WordPress, automation, AI, CRM, SaaS, marketing, SEO, branding, hosting and security—to help businesses build, scale and grow effortlessly.</p>
                            <div className="row">
                                <div className="col-md-6">
                                    <ul className="list-unstyled wow img-custom-anim-top">
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Website Design & Development</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Website Redesign & Optimization</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Website Maintenance & Support</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">WordPress & CMS Development</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Automation & Integrations</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">AI Solutions</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">CRM Development</p>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-md-6">
                                    <ul className="list-unstyled wow img-custom-anim-top">
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">SaaS, Web Apps & Mobile Apps</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Performance Marketing</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">SEO Services</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Social Media Management & Marketing</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Branding, Graphics & Content</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Hosting, Domain & Email Setup</p>
                                        </li>
                                        <li className="d-flex align-items-center mb-3 gap-2">
                                            <div className="position-relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                            ...
                                            <p className="mb-0 text-dark text-uppercase">Security & Performance</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
