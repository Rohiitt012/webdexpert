        ...
        <>
            ...
            <section className="ai-solutions-home-section-5 position-relative overflow-hidden py-30 bg-dark">
                    ...
                    <div className="row mt-80 wow img-custom-anim-left">
                        <div className="col-3 d-flex flex-column gap-5 d-none d-md-flex">
                            <div className="d-flex align-items-center gap-4 justify-content-end">
                                ...
                                <div className="work-icon position-relative">
                                    <img className="position-absolute top-50 start-50 translate-middle" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/icon-1.svg" alt="AstraX" />
                            ...
                            <div className="d-flex align-items-center gap-4 justify-content-end">
                                ...
                                <div className="work-icon position-relative">
                                    <img className="position-absolute top-50 start-50 translate-middle" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/icon-2.svg" alt="AstraX" />
                                    <span className="icon-shape icon-100 rounded-circle" />
                                </div>
                            </div>
                            <div className="d-flex align-items-center gap-4 justify-content-end">
                                ...
                                <div className="work-icon position-relative">
                                    <img className="position-absolute top-50 start-50 translate-middle" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/icon-3.svg" alt="AstraX" />
                                    <span className="icon-shape icon-100 rounded-circle" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="position-relative h-100 w-100">
                                <div className="d-flex align-items-center justify-content-center h-100 position-relative z-1">
                                    <div className="position-absolute top-50 start-50 translate-middle">
                                        <img className="ribbonRotate" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/umbrella.svg" alt="AstraX" />
                                    </div>
                        ...
                        <div className="col-3 d-flex flex-column gap-5 d-none d-md-flex">
                            <div className="d-flex align-items-center gap-4 justify-content-start">
                                <div className="work-icon position-relative">
                                    <img className="position-absolute top-50 start-50 translate-middle" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/icon-4.svg" alt="AstraX" />
                                    <span className="icon-shape icon-100 rounded-circle" />
                                </div>
                ...
                <div className="position-absolute bottom-0 start-50 translate-middle-x z-0 w-100">
                    <img className="w-100" data-aos="fade-up" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-5/bg-bottom.png" alt="AstraX" />
                </div>
            </section>
        </>
    );
