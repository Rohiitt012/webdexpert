                ...
                <div className={`container position-relative z-1 ${bordertop} py-120`}>
                    ...
                    <div className="row mt-8">
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={200}>
                            <div className="card-news position-relative mb-lg-0 mb-5 hover-up">
                                <Link href="/blog-details" className="card-news-img position-relative d-block">
                                    <img className="w-100 rounded-3 rounded-bottom-0" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-8/img-1.png" alt="AstraX" />
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-news position-relative mb-lg-0 mb-5 hover-up">
                                <Link href="/blog-details" className="card-news-img position-relative d-block">
                                    <img className="w-100 rounded-3 rounded-bottom-0" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-8/img-2.png" alt="AstraX" />
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={600}>
                            <div className="card-news position-relative mb-lg-0 mb-5 hover-up">
                                <Link href="/blog-details" className="card-news-img position-relative d-block">
                                    <img className="w-100 rounded-3 rounded-bottom-0" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-8/img-3.png" alt="AstraX" />
