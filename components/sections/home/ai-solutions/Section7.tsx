    ...
    return (
        <>
            ...
            <section className="ai-solutions-home-section-7 position-relative overflow-hidden py-120 bg-dark">
                <img className="position-absolute top-0 start-0" data-aos="fade-right" data-aos-delay={400} src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-7/bg-top.png" alt="AstraX" />
                <img className="position-absolute bottom-0 end-0" data-aos="fade-left" data-aos-delay={400} src="/assets/img/ai-solutions-img/pages/ai-solutions/page-home/home-section-7/bg-bottom.png" alt="AstraX" />
