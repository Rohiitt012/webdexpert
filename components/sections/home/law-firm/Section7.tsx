								...
								<div className="swiper-wrapper z-1">
									<SwiperSlide>
										...
										>
											<div className="position-relative d-inline-flex">
												<img
													src="/assets/img/law-firm-img/pages/law-firm/page-home/home-section-7/img-1.png"
													alt="AstraX"
												/>
									...
									<SwiperSlide>
										...
										>
											<div className="position-relative d-inline-flex">
												<img
													src="/assets/img/law-firm-img/pages/law-firm/page-home/home-section-7/img-2.png"
													alt="AstraX"
												/>
												<div className="team-overlay">
													<ul className="list-unstyled d-flex mb-0 gap-2 justify-content-center position-absolute top-50 start-50 translate-middle">
									...
									<SwiperSlide>
										...
										>
											<div className="position-relative d-inline-flex">
												<img
													src="/assets/img/law-firm-img/pages/law-firm/page-home/home-section-7/img-3.png"
													alt="AstraX"
												/>
												<div className="team-overlay">
													<ul className="list-unstyled d-flex mb-0 gap-2 justify-content-center position-absolute top-50 start-50 translate-middle">
									...
									<SwiperSlide>
										...
										>
											<div className="position-relative d-inline-flex">
												<img
													src="/assets/img/law-firm-img/pages/law-firm/page-home/home-section-7/img-4.png"
													alt="AstraX"
												/>
												<div className="team-overlay">
													<ul className="list-unstyled d-flex mb-0 gap-2 justify-content-center position-absolute top-50 start-50 translate-middle">
