                ...
                <div className="container">
                    ...
                    <div className="row mt-6 g-4">
                        <div className="col-md-4" data-aos="fade-up" data-aos-delay={200}>
                            <div className="text-center hover-up">
                                <Link href="#">
                                    <img src="/assets/img/data-analysis-img/pages/data-analysis/page-home/home-section-8/img-1.png" alt="AstraX" />
                                </Link>
                                <Link href="#">
                        ...
                        <div className="col-md-4" data-aos="fade-up" data-aos-delay={400}>
                            <div className="text-center hover-up">
                                <Link href="#">
                                    <img src="/assets/img/data-analysis-img/pages/data-analysis/page-home/home-section-8/img-2.png" alt="AstraX" />
                                </Link>
                                <Link href="#">
                        ...
                        <div className="col-md-4" data-aos="fade-up" data-aos-delay={600}>
                            <div className="text-center hover-up">
                                <Link href="#">
                                    <img src="/assets/img/data-analysis-img/pages/data-analysis/page-home/home-section-8/img-3.png" alt="AstraX" />
                                </Link>
                                <Link href="#">
