    ...
    return (
        <>
            ...
            <section className="data-analysis-home-section-9 position-relative overflow-hidden py-150 ">
                ...
                <div className="img-bg position-absolute top-50 start-50 translate-middle w-100 h-100" data-background="/assets/img/data-analysis-img/pages/data-analysis/page-home/home-section-9/img-bg.png" />
