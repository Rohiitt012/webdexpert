                        ...
                        <div className="swiper-wrapper z-1 align-items-center">
                            <SwiperSlide>
                                <div className="card-service position-relative d-inline-flex" data-aos="zoom-in" data-aos-delay={0}>
                                    <img src="/assets/img/marketing-agency-img/pages/marketing-agency/page-home/home-section-3/img-1.png" alt="AstraX" />
                            ...
                            <SwiperSlide>
                                <div className="card-service position-relative d-inline-flex" data-aos="zoom-in" data-aos-delay={200}>
                                    <img src="/assets/img/marketing-agency-img/pages/marketing-agency/page-home/home-section-3/img-2.png" alt="AstraX" />
                                    <div className="position-absolute bottom-0 start-0">
                                        <Link href="#">
                            ...
                            <SwiperSlide>
                                <div className="card-service position-relative d-inline-flex" data-aos="zoom-in" data-aos-delay={400}>
                                    <img src="/assets/img/marketing-agency-img/pages/marketing-agency/page-home/home-section-3/img-3.png" alt="AstraX" />
                                    <div className="position-absolute bottom-0 start-0">
                                        <Link href="#">
                            ...
                            <SwiperSlide>
                                <div className="card-service position-relative d-inline-flex" data-aos="zoom-in" data-aos-delay={600}>
                                    <img src="/assets/img/marketing-agency-img/pages/marketing-agency/page-home/home-section-3/img-4.png" alt="AstraX" />
                                    <div className="position-absolute bottom-0 start-0">
                                        <Link href="#">
                            ...
                            <SwiperSlide>
                                <div className="card-service position-relative d-inline-flex" data-aos="zoom-in" data-aos-delay={800}>
                                    <img src="/assets/img/marketing-agency-img/pages/marketing-agency/page-home/home-section-3/img-5.png" alt="AstraX" />
                                    <div className="position-absolute bottom-0 start-0">
                                        <Link href="#">
