                ...
                <div className="container position-relative">
                    ...
                    <div className="row align-items-center mb-120">
                        <div className="col-lg-6 mb-lg-0 mb-5" data-aos="fade-right">
                            <div className="position-relative">
                                <div className="rounded-4 overflow-hidden border border-light shadow-lg p-5 bg-light d-flex align-items-center justify-content-center" style={{ minHeight: '400px' }}>
                    ...
                    <div className="row align-items-center mb-120">
                        ...
                        <div className="col-lg-6 order-lg-1" data-aos="fade-right">
                            <h2 className="text-dark mb-4">🔁 Lead Capture → Follow-up Automation</h2>
                            <p className="fs-6 text-muted">
                    ...
                    <div className="row align-items-center mb-120">
                        ...
                        <div className="col-lg-6" data-aos="fade-left">
                            <h2 className="text-dark mb-4">📈 Sales &amp; Marketing Automation</h2>
                            <p className="fs-6 text-muted">
