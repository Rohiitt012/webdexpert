                ...
                <div className="pb-80 pt-120 d-flex align-items-center justify-content-between position-relative z-1">
                    <div className="container d-flex flex-wrap align-items-center justify-content-between">
                        <div className="text-start">
                            ...
                            <h2 className="text-dark my-3 text-anime-style-2">What our users says</h2>
                        </div>
                        <div className="d-flex justify-content-lg-end">
                            <Link href="#">
                                <img className="wow img-custom-anim-left" src="/assets/img/fintech-solution-img/pages/fintech-solution/page-home/home-section-4/logo.png" alt="AstraX" />
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row group-card-testimonial position-relative z-0">
                        <div className="col-lg-4">
                            ...
                            <div className="card-testimonial mb-4 border p-5 rounded-4">
                                ...
                                <div className="d-flex align-items-center mt-5">
                                    <Link href="#">
                                        <img className="rounded-circle icon-shape icon-50" src="/assets/img/fintech-solution-img/pages/fintech-solution/page-home/home-section-4/author-2.png" alt="AstraX" />
                                    </Link>
                                    <div className="text-start ms-3">
                                        <Link href="#">
                                            <span className="fw-semibold">Sophia J. Carter</span>
                                        </Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 mt-5">
                            ...
                            <div className="card-testimonial mb-4 border p-5 rounded-4">
                                ...
                                <div className="d-flex align-items-center mt-5">
                                    <Link href="#">
                                        <img className="rounded-circle icon-shape icon-50" src="/assets/img/fintech-solution-img/pages/fintech-solution/page-home/home-section-4/author-5.png" alt="AstraX" />
                                    </Link>
                                    <div className="text-start ms-3">
                                        <Link href="#">
