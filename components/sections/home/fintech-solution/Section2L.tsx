export default function Section2L() {
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="text-dark mb-5 fw-bold">Here's what is available if you choose our CRM:</h3>
                            <ul className="list-unstyled">
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                        ...
                                        <svg className="fill-primary position-absolute top-50 start-50 translate-middle" xmlns="http://www.w3.org/2000/svg" width={10} height={8} viewBox="0 0 10 8" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">Custom CRM systems (cloud-based &amp; scalable)</p>
                                </li>
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">Lead &amp; pipeline management</p>
                                </li>
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">Client &amp; sales tracking dashboards</p>
                                </li>
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">Automated WhatsApp / Email follow-ups</p>
                                </li>
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">CRM + API integrations (Meta, Google, WhatsApp)</p>
                                </li>
                                <li className="d-flex align-items-start mb-4 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                    ...
                                    <p className="mb-0 text-dark">Lead capture from ads, forms &amp; platforms</p>
                                </li>
                                <li className="d-flex align-items-start mb-0 gap-3">
                                    <div className="position-relative mt-1">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
                                            <path opacity="0.2" d="M17.0711 3.79231C15.1823 1.9036 12.6711 0.863403 10 0.863403C7.32887 0.863403 4.81762 1.9036 2.92891 3.79231C1.04016 5.68106 0 8.19231 0 10.8634C0 13.5345 1.04016 16.0457 2.92891 17.9345C4.81766 19.8232 7.32887 20.8634 10 20.8634C12.6711 20.8634 15.1823 19.8232 17.0711 17.9345C18.9598 16.0457 20 13.5345 20 10.8634C20 8.19231 18.9598 5.6811 17.0711 3.79231ZM10 19.6915C5.13215 19.6915 1.17188 15.7313 1.17188 10.8634C1.17188 5.99555 5.13215 2.03528 10 2.03528C14.8679 2.03528 18.8281 5.99555 18.8281 10.8634C18.8281 15.7313 14.8679 19.6915 10 19.6915Z" fill="#794AFF" />
                                        </svg>
                                    ...
                                    <p className="mb-0 text-dark">Centralized client documents &amp; data</p>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-6">
