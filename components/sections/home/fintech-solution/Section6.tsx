                    ...
                    <div className="row g-5 mb-80 align-items-center">
                        <div className="col-lg-auto me-lg-auto">
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <span className="btn-text" style={{ color: '#FDB913' }}>pricing plan</span>
                            </div>
                    ...
                    <div className="row g-lg-5 g-4">
                        <div className="col-lg-4">
                            <div className="card-pricing rounded-4 border p-md-6 p-4">
                                <span className="btn-text" style={{ color: '#FDB913' }}>Basic CRM</span>
                        ...
                        <div className="col-lg-4">
                            <div className="card-pricing rounded-4 border p-md-6 p-4">
                                <span className="btn-text" style={{ color: '#FDB913' }}>Advanced CRM</span>
                                <div className="mb-3 pricing__price">
                                    <div className="d-flex align-items-baseline">
                                        <h1 className="mb-0 me-1">₹</h1>
                                ...
                                <div className="d-block">
                                    <svg className="" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                        <g clipPath="url(#clip0_349_1213)">
                                            <path d="M13.9476 4.03755C13.8717 3.96164 13.7721 3.92368 13.6723 3.92368C13.5727 3.92368 13.473 3.96161 13.3971 4.03751C13.2453 4.18932 13.2453 4.43632 13.3971 4.58809C13.5489 4.73997 13.7959 4.7399 13.9476 4.58809C14.0211 4.51455 14.0616 4.41678 14.0616 4.31278C14.0617 4.20886 14.0212 4.11109 13.9476 4.03755Z" fill="#FDB913" />
                                            <path d="M7.50275 9.75126C7.39735 9.64586 7.29782 9.59485 7.20403 9.59794C7.11026 9.60114 7.017 9.64902 6.92429 9.74177L6.61133 10.0547L7.19928 10.6427L7.51224 10.3297C7.60495 10.237 7.65287 10.1438 7.65606 10.05C7.65923 9.95625 7.60815 9.85669 7.50275 9.75126Z" fill="#FDB913" />
                                            <path
                                    ...
                                    <svg className="" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                        <g clipPath="url(#clip0_349_1230)">
                                            ...
                                            <path
                                                ...
                                                fill="#FDB913"
                                            />
                                            <path d="M6.85529 0.760009C6.21038 0.28459 5.41507 0 4.55239 0C2.40394 0 0.662109 1.74186 0.662109 3.89028C0.662109 4.41838 0.768247 4.92158 0.95913 5.38052C2.1535 3.0947 4.29212 1.3847 6.85529 0.760009Z" fill="#FDB913" />
                                            <path d="M17.0404 5.38055C17.2312 4.92131 17.3374 4.4181 17.3374 3.89031C17.3377 1.74186 15.5959 0 13.4474 0C12.5841 0 11.7894 0.28459 11.1445 0.76061C13.7074 1.38498 15.846 3.09531 17.0404 5.38055Z" fill="#FDB913" />
                                        </g>
                                    </svg>
                                </div>
