                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 order-3 mt-lg-0 mt-8 wow img-custom-anim-left">
                            <div className="position-relative d-inline-block">
                                <img className="rounded-4" src="/assets/img/accounting-service-img/pages/ai-solutions/page-home/home-section-4/img-1.png" alt="AstraX" />
                                <img className="position-absolute top-0 start-0 p-5 alltuchtopdown" src="/assets/img/accounting-service-img/pages/ai-solutions/page-home/home-section-4/img-2.png" alt="AstraX" />
                            </div>
                        </div>
                    </div>
                </div>
