                ...
                <div className="container position-relative z-1">
                    <div className="row align-items-center">
                            ...
                            <div className="row g-2">
                                <div className="col-md-6 text-center">
                                    <div className="position-relative">
                                        <img data-aos="fade-up" className="rounded-4" src="/assets/img/accounting-service-img/pages/ai-solutions/page-home/home-section-2/img-1.png" alt="AstraX" />
                                ...
                                <div className="col-md-6 mt-md-8 mt-10 pt-md-0 pt-5 text-center">
                                    <div className="d-flex align-items-start text-start mb-5 ms-md-0 ms-5" data-aos="fade-left" data-aos-delay={200}>
                                        ...
                                        <div className="ms-3">
                                            ...
                                            <p className="mb-0">
                                                Line make <span className="text-primary">/Per sec</span>
                                            </p>
                                        </div>
                                    </div>
                                    <img data-aos="fade-up" data-aos-delay={400} className="rounded-4" src="/assets/img/accounting-service-img/pages/ai-solutions/page-home/home-section-2/img-2.png" alt="AstraX" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5 offset-lg-1 col-md-12 order-2 ">
                            ...
                            <h2 className="text-dark my-3 text-anime-style-3">Navigate success with our ai expertise</h2>
                            <p className="pb-4 text wow img-custom-anim-top">We offer a wide range of digital marketing services that cater to business of all sizes. A forward-thinking and clever approach to maintaining sales tax compliance amidst the digital era.</p>
                            <ul className="list-unstyled d-flex flex-wrap wow img-custom-anim-top">
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Creative Writing</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Film and Animation</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Fashion Design</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Photography</p>
                                </li>
                            </ul>
