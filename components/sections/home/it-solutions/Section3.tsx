        ...
        <>
            ...
            <section className="it-solutions-home-section-3 position-relative overflow-hidden pt-120 pb-120 bg-light-2">
                <div className="position-absolute top-50 start-50 translate-middle">
                    <img data-aos="zoom-in" src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-3/decor-bg.png" alt="AstraX" />
                </div>
                    ...
                    <div className="row g-md-5 g-3">
                        ...
                        <div className="col-lg-3 col-6">
                            <div className="text-center">
                                ...
                                <h1 className="count mb-0">
                                    <span className="odometer text-nowrap" data-count={100} />k
                                </h1>
                                <p>Projects done</p>
                            </div>
                        </div>
                        <div className="col-lg-3 col-6">
                            <div className="text-center">
                                ...
                                <h1 className="count mb-0">
                                    <span className="odometer text-nowrap" data-count={1} />
                                    M+
                                </h1>
                                <p>Active reviews</p>
                            </div>
