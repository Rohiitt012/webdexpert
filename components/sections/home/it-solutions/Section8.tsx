                        ...
                        <div className="swiper-wrapper z-1">
                            <SwiperSlide>
                                <div className="rounded-4 overflow-hidden zoom-img" data-aos="zoom-in" data-aos-delay={0}>
                                    <img src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-8/img-1.png" alt="AstraX" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="rounded-4 overflow-hidden zoom-img" data-aos="zoom-in" data-aos-delay={200}>
                                    <img src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-8/img-2.png" alt="AstraX" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="rounded-4 overflow-hidden zoom-img" data-aos="zoom-in" data-aos-delay={400}>
                                    <img src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-8/img-3.png" alt="AstraX" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="rounded-4 overflow-hidden zoom-img" data-aos="zoom-in" data-aos-delay={600}>
                                    <img src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-8/img-4.png" alt="AstraX" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="rounded-4 overflow-hidden zoom-img" data-aos="zoom-in" data-aos-delay={800}>
                                    <img src="/assets/img/it-solutions-img/pages/it-solutions/page-home/home-section-8/img-5.png" alt="AstraX" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
