                    ...
                    <div className="row pt-10">
                        <div className="col-lg-4">
                            <div className="card-process d-flex align-items-center" data-aos="fade-left" data-aos-delay={0}>
                                <div>
                                    <Link href="#" className="icon-shape icon-100 rounded-circle bg-secondary-3 me-3">
                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-4/icon-1.svg" alt="AstraX" />
                                    </Link>
                                </div>
                                <div>
                            ...
                            <div className="card-process d-flex align-items-center" data-aos="fade-left" data-aos-delay={200}>
                                <div>
                                    <Link href="#" className="icon-shape icon-100 rounded-circle bg-secondary-3 me-3">
                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-4/icon-2.svg" alt="AstraX" />
                                    </Link>
                                </div>
                                <div>
                                    <Link href="#" className="text-primary-2 fs-20 fw-bold">
                            ...
                            <div className="card-process d-flex align-items-center mb-4" data-aos="fade-left" data-aos-delay={400}>
                                <div>
                                    <Link href="#" className="icon-shape icon-100 rounded-circle bg-secondary-3 me-3">
                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-4/icon-3.svg" alt="AstraX" />
                                    </Link>
                                </div>
                                <div>
                                    <Link href="#" className="text-primary-2 fs-20 fw-bold">
                        ...
                        <div className="col offset-lg-1 mt-lg-0 mt-8">
                            <div className="position-relative" data-aos="fade-up">
                                ...
                                <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-4/img-1.png" alt="AstraX" />
                            </div>
                        </div>
                    </div>
                </div>
