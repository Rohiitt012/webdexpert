        ...
        <>
            ...
            <section className="insurance-consultancy-home-section-1">
                ...
                <div className="position-relative text-center picture-bg d-none d-lg-block">
                    <img className="wow img-custom-anim-left" src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-1/img-1.png" alt="AstraX" />
                </div>
            </section>
