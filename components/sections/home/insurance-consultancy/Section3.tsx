                                            ...
                                            <div className="container position-relative">
                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-3/img-1.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-service-2 bg-primary-2 py-120 rounded-5">
                                            <div className="container position-relative">
                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-3/img-2.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-service-2 bg-primary py-120 rounded-5">
                                            <div className="container position-relative">
                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="/assets/img/insurance-consultancy-img/pages/insurance-consultancy/page-home/home-section-3/img-3.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
