...
export default function Section2() {
    return (
        <>
            {/*tax-software section 2*/}
            <section className="tax-software-section-2 position-relative overflow-hidden pt-120">
                <div className="container">
                    <div className="row pb-lg-120 pb-8 align-items-center">
                        <div className="col-lg-5">
                            <img className="mt-lg-0 mb-5" data-aos="zoom-in" src="/assets/img/tax-software-img/pages/tax-software/page-home/home-section-2/img-1.png" alt="AstraX" />
                        </div>
                        <div className="col-lg-5 offset-lg-1">
                            <h2 className="my-3 wow img-custom-anim-left">
                                User <span className="text-primary text-decoration-underline">authentication</span>
                            </h2>
                            ...
                            <Link href="/about" className="btn btn-outline-dark mt-4">
                                <span>read more</span>
                    ...
                    <div className="row pb-lg-120 pb-8 align-items-center">
                        <div className="col-lg-5 order-lg-2 offset-lg-1">
                            <img className="mt-lg-0 mb-5" data-aos="zoom-in" src="/assets/img/tax-software-img/pages/tax-software/page-home/home-section-2/img-2.png" alt="AstraX" />
                        </div>
                        <div className="col-lg-5 order-lg-1">
                            <h2 className="my-3 wow img-custom-anim-left">
                                Tax form <span className="text-primary text-decoration-underline">integration</span>
                            </h2>
                            <p className="pb-4 text-anime-style-1">We offer a wide range of digital marketing services that cater to business of all sizes. A forward-thinking and clever approach.</p>
                            <ul className="list-unstyled">
                                <li className="d-flex align-items-center mb-3 gap-3" data-aos="fade-left" data-aos-delay={0}>
                    ...
                    <div className="row pb-120 align-items-center">
                        <div className="col-lg-5">
                            <img className="mt-lg-0 mb-5" data-aos="zoom-in" src="/assets/img/tax-software-img/pages/tax-software/page-home/home-section-2/img-3.png" alt="AstraX" />
                        </div>
                        <div className="col-lg-5 offset-lg-1">
                            <h2 className="my-3 wow img-custom-anim-left">
                                Income &amp; expense <span className="text-primary text-decoration-underline">track</span>
                            </h2>
                            <p className="pb-4 text-anime-style-1">We offer a wide range of digital marketing services that cater to business of all sizes. A forward-thinking and clever approach.</p>
                            <ul className="list-unstyled">
                                <li className="d-flex align-items-center mb-3 gap-3" data-aos="fade-left" data-aos-delay={0}>
