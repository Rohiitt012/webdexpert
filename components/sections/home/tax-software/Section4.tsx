...
export default function Section4() {
    return (
        <>
            {/*tax-software section 4*/}
            <section className="tax-software-section-4 position-relative overflow-hidden py-120">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5 col-md-12">
                            <span className="btn-text text-primary">our plans</span>
                            <h2 className="text-dark my-3 wow img-custom-anim-left">
                                Tailored pricing plans <span className="text-primary text-decoration-underline">for everyone</span>
                            </h2>
                            <p className="pb-4 text-anime-style-1">We offer a wide range of digital marketing services that cater to business of all sizes. A forward-thinking and clever approach to maintaining sales tax compliance.</p>
                            <ul className="list-unstyled d-flex flex-wrap">
                                <li className="d-flex align-items-center mb-3 gap-3 w-md-50 w-100" data-aos="fade-up" data-aos-delay={0}>
                                    <div className="position-relative">
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                            <g clipPath="url(#clip0_349_9235)">
                                                <path d="M13.9476 4.03755C13.8717 3.96164 13.7721 3.92368 13.6723 3.92368C13.5727 3.92368 13.473 3.96161 13.3971 4.03751C13.2453 4.18932 13.2453 4.43632 13.3971 4.58809C13.5489 4.73997 13.7959 4.7399 13.9476 4.58809C14.0211 4.51455 14.0616 4.41678 14.0616 4.31278C14.0617 4.20886 14.0212 4.11109 13.9476 4.03755Z" fill="#794AFF" />
                                                <path d="M7.50275 9.75127C7.39735 9.64587 7.29782 9.59486 7.20403 9.59796C7.11026 9.60116 7.017 9.64904 6.92429 9.74178L6.61133 10.0547L7.19928 10.6427L7.51224 10.3297C7.60495 10.237 7.65287 10.1438 7.65606 10.05C7.65923 9.95627 7.60815 9.85671 7.50275 9.75127Z" fill="#794AFF" />
                                                <path
                                        ...
                                        <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                            <g clipPath="url(#clip0_349_9252)">
                                                ...
                                                <path
                                                    ...
                                                    fill="#794AFF"
                                                />
                                                <path d="M6.85529 0.760009C6.21038 0.28459 5.41507 0 4.55239 0C2.40394 0 0.662109 1.74186 0.662109 3.89028C0.662109 4.41838 0.768247 4.92158 0.95913 5.38052C2.1535 3.0947 4.29212 1.3847 6.85529 0.760009Z" fill="#794AFF" />
                                                <path d="M17.0404 5.38055C17.2312 4.92131 17.3374 4.4181 17.3374 3.89031C17.3377 1.74186 15.5959 0 13.4474 0C12.5841 0 11.7894 0.28459 11.1445 0.76061C13.7074 1.38498 15.846 3.09531 17.0404 5.38055Z" fill="#794AFF" />
                                            </g>
                                        </svg>
                                    </div>
                                    <p className="mb-0 text-dark">You can cancel anytime</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-3 w-md-50 w-100" data-aos="fade-up" data-aos-delay={400}>
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                            <g clipPath="url(#clip0_1861_29270)">
                                                <path
                                                    d="M17.9956 3.45265C17.9956 6.18733 16.8034 8.1741 16.7533 8.25696C16.6523 8.42201 16.4775 8.51254 16.2972 8.51254C16.2025 8.51254 16.107 8.48746 16.0207 8.43524C15.7686 8.28203 15.6878 7.95404 15.8403 7.70195C15.8515 7.68384 16.9274 5.87535 16.9274 3.45265C16.9274 2.07103 16.0291 1.06825 14.7909 1.06825C13.6126 1.06825 12.6544 2.02646 12.6544 3.20543C12.6544 3.70752 12.8974 4.98329 12.9908 5.43245C13.0513 5.72145 12.8654 6.00418 12.5764 6.06476C12.2874 6.12396 12.0047 5.93941 11.9448 5.65111C11.9079 5.47493 11.5848 3.90877 11.5848 3.20543C11.5848 1.43802 13.0228 0 14.7909 0C16.6175 0 17.9956 1.48398 17.9956 3.45265ZM14.8814 4.29318C15.0938 6.06824 15.4016 9.52716 15.0479 9.87953L7.28602 17.6421C6.809 18.1198 6.03393 18.1198 5.55621 17.6414L0.366099 12.452C-0.111616 11.9749 -0.111616 11.1999 0.366099 10.7221L8.12863 2.96031C8.25189 2.83705 9.59451 2.83148 11.1043 2.91017C11.0959 3.00975 11.0743 3.10376 11.0743 3.20543C11.0743 3.59262 11.16 4.1929 11.2498 4.72075C11.0917 4.95543 10.9991 5.23747 10.9991 5.54178C10.9991 6.35237 11.6565 7.00975 12.4671 7.00975C13.2777 7.00975 13.935 6.35237 13.935 5.54178C13.935 5.04248 13.685 4.60237 13.3041 4.33774C13.2261 3.87326 13.1635 3.42479 13.1635 3.20543C13.1635 3.15808 13.1732 3.11421 13.1774 3.06755C13.3633 3.08705 13.5465 3.10724 13.7199 3.12883C14.7456 3.25487 14.7561 3.25279 14.8814 4.29318ZM10.7442 10.1024C10.6238 9.76741 10.4232 9.3656 9.98797 8.9032L10.5771 8.31337L9.92111 7.65808L9.28532 8.29457C8.43435 7.7117 7.55691 7.75905 6.9615 8.35446C6.31248 9.00348 6.46568 9.8273 6.942 10.7848C7.2693 11.4478 7.32919 11.8294 7.07501 12.0836C6.81387 12.3447 6.39256 12.2312 6.01025 11.8496C5.57571 11.415 5.32084 10.8781 5.19409 10.4429L4.20941 11.0265C4.32362 11.4206 4.63142 11.9826 5.06596 12.445L4.4239 13.0877L5.07919 13.7437L5.7693 13.0543C6.67947 13.6964 7.5973 13.61 8.1927 13.0146C8.80203 12.4039 8.85565 11.7214 8.33337 10.6372C7.97125 9.86003 7.88421 9.47841 8.09869 9.26462C8.28671 9.0766 8.62097 9.02298 9.05621 9.45822C9.5388 9.94081 9.69897 10.4095 9.78602 10.6574L10.7442 10.1024Z"
                                                    fill="#794AFF"
                                                />
                                            </g>
                                        </svg>
                                    </div>
                                    <p className="mb-0 text-dark">No any hidden fees pay</p>
                                </li>
                            </ul>
                            <Link href="/contact" className="btn btn-outline-dark mt-4">
                        ...
                        <div className="col-lg-6 offset-lg-1 mt-lg-0 mt-8">
                            <div className="row g-4">
                                <div className="col-md-6">
                                    <div data-aos="fade-up" data-aos-delay={200} className="card-pricing rounded-4 border p-md-6 p-4">
                                        <span className="text-primary btn-text">basic plan</span>
                                        <h1 className="mb-3">$49</h1>
                                        <p className="fs-7">Best for small business owners, startups who needs.</p>
                                        <Link href="/pricing-plan" className="btn btn-outline-dark w-100 mb-6 mt-2 hover-up">
                                            try for free
                                        </Link>
                                ...
                                <div className="col-md-6">
                                    <div data-aos="fade-up" data-aos-delay={400} className="card-pricing rounded-4 border border-primary p-md-6 p-4 position-relative">
                                        <span className="text-primary btn-text">team plan</span>
                                        <h1 className="mb-3">$299</h1>
                                        <p className="fs-7">Best for small business owners, startups who needs.</p>
                                        <Link href="/pricing-plan" className="btn btn-primary border-dark w-100 mb-6 mt-2 hover-up">
                                            try for free
                                        </Link>
                                        <span className="btn-text">What’s included:</span>
                                        <ul className="list-unstyled mt-3 mb-0">
