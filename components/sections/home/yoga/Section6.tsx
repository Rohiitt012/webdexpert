            ...
            <section className="yoga-section-6 position-relative overflow-hidden pt-120">
                <div className="container">
                    <div className="text-center mb-80">
                        <div className="icon">
                            <img src="/assets/img/yoga-img/pages/yoga/template/icons/icon.svg" alt="AstraX" />
                        </div>
                                    ...
                                    <SwiperSlide>
                                        <div className="card-testimonial bg-secondary-2 bg-opacity-10 rounded-3 overflow-hidden" data-aos="fade-up">
                                            <div className="position-absolute bottom-0 end-0 me-8 z-0">
                                                <img src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/icon-1.svg" alt="AstraX" />
                                            </div>
                                            <div className="d-flex position-relative z-1">
                                                <img className="d-none d-lg-block" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/img-1.png" alt="AstraX" />
                                                <div className="d-flex flex-column m-lg-8 m-md-6 m-5">
                                                    ...
                                                    <div className="d-flex align-items-center position-relative z-1 mt-lg-auto mt-5">
                                                        <Link href="#">
                                                            <img className="rounded-circle icon-shape icon-50" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/author-1.png" alt="AstraX" />
                                                        </Link>
                                        ...
                                        <div className="card-testimonial bg-secondary-2 bg-opacity-10 rounded-3 overflow-hidden" data-aos="fade-up">
                                            ...
                                            <div className="d-flex position-relative z-1">
                                                ...
                                                <div className="d-flex flex-column m-lg-8 m-md-6 m-5">
                                                    ...
                                                    <div className="d-flex align-items-center position-relative z-1 mt-lg-auto mt-5">
                                                        <Link href="#">
                                                            <img className="rounded-circle icon-shape icon-50" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/author-2.png" alt="AstraX" />
                                                        </Link>
                                                        <div className="text-start ms-3">
                                                            <Link href="#">
                                                                <h6 className="fs-18">Isabella F. Monroe</h6>
                                ...
                                <SwiperSlide>
                                    <div>
                                        <div className="icon-shape icon-xxl rounded-circle border">
                                            <img src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/icon-yoga.svg" alt="AstraX" />
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
