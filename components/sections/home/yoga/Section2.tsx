                    ...
                    <div className="row g-md-5">
                        <div className="col-md-6">
                            <div className="border-top-md">
                                <div className="card-service tg-img-reveal-item w-100 border-bottom py-5" data-fx={1} data-img="/assets/img/yoga-img/pages/yoga/page-home/home-section-2/img-hover.png">
