                ...
                <div className="container">
                    ...
                    <div className="row mt-8">
                        <div className="col-lg-4" data-aos="fade-up" data-aos-delay={0}>
                            <div className="card-news position-relative mb-lg-0 mb-md-5 hover-up">
                                <Link href="#" className="card-news-img position-relative d-block">
                                    <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-9/img-1.png" alt="AstraX" />
                        ...
                        <div className="col-lg-4" data-aos="fade-up" data-aos-delay={200}>
                            <div className="card-news position-relative mb-lg-0 mb-md-5 hover-up">
                                <Link href="#" className="card-news-img position-relative d-block">
                                    <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-9/img-2.png" alt="AstraX" />
                        ...
                        <div className="col-lg-4" data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-news position-relative mb-lg-0 mb-md-5 hover-up">
                                <Link href="#" className="card-news-img position-relative d-block">
                                    <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-9/img-3.png" alt="AstraX" />
