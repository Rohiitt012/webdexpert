                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 col-12 mb-lg-0 mb-5 order-lg-2 order-1 position-relative">
                            <div className="alltuchtopdown">
                                <img className="z-0 position-absolute top-100 start-lg-100 start-50 translate-middle-x d-inline-block" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-6/icon-spa.png" alt="AstraX" />
                            </div>
                            <div className="icon">
