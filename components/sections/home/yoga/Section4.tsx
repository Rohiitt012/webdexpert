                            ...
                            <Swiper {...swiperOptions} className="swiper slider-4 pb-1">
                                <div className="swiper-wrapper z-1">
                                    <SwiperSlide>
                                        <div className="card-news position-relative mb-lg-0 mb-8 hover-up py-2">
                                            <Link href="/classes-details" className="card-news-img position-relative d-block">
                                                <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-4/img-1.png" alt="AstraX" />
                                    ...
                                    <SwiperSlide>
                                        <div className="card-news position-relative mb-lg-0 mb-8 hover-up py-2">
                                            <Link href="/classes-details" className="card-news-img position-relative d-block">
                                                <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-4/img-2.png" alt="AstraX" />
                                                <div className="icon-shape icon-xxl rounded-circle bg-white shadow-1 position-absolute top-100 end-0 translate-middle-y me-5">
                                                    <div>
                                    ...
                                    <SwiperSlide>
                                        <div className="card-news position-relative mb-lg-0 mb-8 hover-up py-2">
                                            <Link href="/classes-details" className="card-news-img position-relative d-block">
                                                <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-4/img-3.png" alt="AstraX" />
                                                <div className="icon-shape icon-xxl rounded-circle bg-white shadow-1 position-absolute top-100 end-0 translate-middle-y me-5">
                                                    <div>
                                    ...
                                    <SwiperSlide>
                                        <div className="card-news position-relative mb-lg-0 mb-8 hover-up py-2">
                                            <Link href="/classes-details" className="card-news-img position-relative d-block">
                                                <img className="w-100" src="/assets/img/yoga-img/pages/yoga/page-home/home-section-4/img-4.png" alt="AstraX" />
                                                <div className="icon-shape icon-xxl rounded-circle bg-white shadow-1 position-absolute top-100 end-0 translate-middle-y me-5">
                                                    <div>
                                                        <h6 className="mb-0">$49</h6>
                                                    </div>
