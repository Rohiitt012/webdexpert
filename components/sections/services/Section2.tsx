                    ...
                    <div className="row">
                        <div className="col-lg-5">
                            ...
                            <div className="bg-white bg-opacity-10 d-flex flex-wrap align-items-center justify-content-md-between justify-content-center gap-5 mt-5 px-5 py-4 wow img-custom-anim-left">
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-1.svg" alt="client-logo" />
                                </Link>
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-2.svg" alt="client-logo" />
                                </Link>
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-3.svg" alt="client-logo" />
                                </Link>
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-4.svg" alt="client-logo" />
                                </Link>
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-5.svg" alt="client-logo" />
                                </Link>
                                <Link href="#">
                                    <img src="/assets/img/ai-solutions-img/pages/ai-solutions/icons/app-6.svg" alt="client-logo" />
                                </Link>
                            </div>
                        </div>
