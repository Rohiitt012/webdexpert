                ...
                <div className="container position-relative z-1">
                    <div className="row align-items-center">
                        <div className="col-lg-6 d-none d-lg-block">
                            <img className="zoom-img" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-about/img-1.png" alt="AstraX" />
                        </div>
                        <div className="col-lg-6 col-md-12 order-2 ">
                            <div className="d-flex align-items-center gap-3">
                                <span className="small-line" />
                                <span className="btn-text text-warning">about us</span>
                            </div>
                            <h2 className="text-dark my-3">Your Complete Digital Partner for Design, Development & Growth</h2>
                            <p className="pb-4 text">We are a full-service digital solutions company helping businesses build, grow, and scale their online presence with modern technology, automation, and performance-driven strategies. From idea to execution, we deliver reliable, scalable, and result-oriented digital solutions tailored to your business goals.</p>
                            <ul className="list-unstyled d-flex flex-wrap">
                                {[
                                    ...
                                    "Automation & Integrations (WhatsApp + Workflows)",
                                    "AI Solutions",
                                    "CRM Development",
                                    ...
                                    "Branding, Graphics & Content",
                                    "Hosting, Domain & Email Setup",
                                    "Security & Performance"
                                ].map((service, index) => (
                                    <li key={index} className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                        <div className="position-relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                                <circle className="fill-warning" cx={7} cy={7} r={7} fill="#FFC107" />
                                                <path
                                        ...
                                        <p className="mb-0 text-dark text-uppercase">{service}</p>
                                    </li>
                                ))}
                            </ul>
                            <Link href="/contact" className="btn bg-black text-white hover-up mt-3">
