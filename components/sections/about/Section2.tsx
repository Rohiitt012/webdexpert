                ...
                <div className="container position-relative z-1">
                    ...
                    <div className="row mt-5 g-4">
                        <div className="col-md-5">
                            <img className="wow img-custom-anim-left" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-about/img-2.png" alt="AstraX" />
                        </div>
                        <div className="col-md-7">
                            <img className="wow img-custom-anim-right" src="/assets/img/ai-solutions-img/pages/ai-solutions/page-about/img-3.png" alt="AstraX" />
                        </div>
                    </div>
